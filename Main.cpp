...
void (*FreskinExample)(void *instance, int amount);
...
void *hack_thread(void *) {
    ...
    // RET = C0 03 5F D6
    hexPatches.Freskin = MemoryPatch::createWithHex(targetLibName,
                                                    string2Offset(OBFUSCATE("0xBEEE3C")),
                                                    OBFUSCATE("00 00 80 D2 C0 03 5F D6"));
    //You can also specify target lib like this
    hexPatches.Freskin = MemoryPatch::createWithHex("libtargetLibHere.so",
                                                     string2Offset(OBFUSCATE("0xBEEE3c")),
...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("Toggle_Freskin"),
            OBFUSCATE("100_Toggle_Radar"), //This one have feature number assigned, and switched on by default
            OBFUSCATE("110_Toggle_kode"), //This one too   
